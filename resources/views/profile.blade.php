                                        ...
                                        <div class="dashbox__list-wrap">
                                            <div class="dashbox__scroll">
                                                <div class="dashbox__note dashbox__note--succ">
                                                    ...
                                                    <p><a href="#modal-info2" class="open-modal">Payment #51</a> was
                                                        successful!</p>
                                                ...
                                                <div class="dashbox__note dashbox__note--info">
                                                    ...
                                                    <p><a href="#modal-info4" class="open-modal">Example</a> of
                                                        notification.</p>
                                                    <span>2 hours ago</span>
                                                </div>
                                                <div class="dashbox__note dashbox__note--gift">
                                                    ...
                                                    <p><a href="#modal-info5" class="open-modal">You have received a
                                                            gift!</a></p>
                                            ...
                                            <div class="dashbox__table-scroll">
                                                <table class="main__table">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th><a href="#" class="active">Title
                                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                                                    <path
                                                                        d="M17,13.41,12.71,9.17a1,1,0,0,0-1.42,0L7.05,13.41a1,1,0,0,0,0,1.42,1,1,0,0,0,1.41,0L12,11.29l3.54,3.54a1,1,0,0,0,.7.29,1,1,0,0,0,.71-.29A1,1,0,0,0,17,13.41Z"/>
                                                                </svg>
                                                            </a></th>
                                                        <th><a href="#" class="active">Date
                                                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                                                    <path
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="main__table-text main__table-text--number"><a
                                                                    href="#modal-info" class="open-modal">631</a></div>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="main__table-text main__table-text--number"><a
                                                                    href="#modal-info" class="open-modal">632</a></div>
                                                        </td>
                                                        <td>
                                                            <div class="main__table-img">
                                                                <img src="img/store/item3.jpg" alt="">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="main__table-text main__table-text--number"><a
                                                                    href="#modal-info" class="open-modal">708</a></div>
                                                        </td>
                                                        <td>
                                                            <div class="main__table-img">
                                                        ...
                                                        <td>
                                                            <div class="main__table-text"><a href="#">Headphones ZR-991</a>
                                                            </div>
                                                        </td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="main__table-text main__table-text--number"><a
                                                                    href="#modal-info" class="open-modal">750</a></div>
                                                        </td>
                                                        <td>
                                                            <div class="main__table-img">
                                                        ...
                                                        <td>
                                                            <div class="main__table-text main__table-text--price">$11 899
                                                            </div>
                                                        </td>
                                                        <td>
                                                            <div class="main__table-text main__table-text--green">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12 col-md-6 col-lg-12 col-xl-6">
                                                <div class="sign__group">
                                                    ...
                                                    <input id="username" type="radio" name="username" value="1" class="sign__input">
                                                </div>
                                            </div>
